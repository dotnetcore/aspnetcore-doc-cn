...
然而，我们可以利用ASP.NET Core 中间件:doc: `middleware </fundamentals/middleware>`的优势，可以帮助我们在它自己的类中封装素数检测的逻辑，并且在 ``Configure`` 方法中实现更好的 ` 分离关注点 <http://deviq.com/separation-of-concerns/>`_ 。
